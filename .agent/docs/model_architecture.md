...
- **Encoder**: A deep **VGG19** backbone replaces standard VGG architectures to improve spatial feature extraction and mitigate vanishing gradients via residual connections.
