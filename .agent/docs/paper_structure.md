...
## 2. Core Sections
1. **Abstract**: High-level summary of the challenges (diacritics, noise), the proposed hybrid pipeline (CLAHE, Projection Profiles + VGG19/Transformer), and the writer-independent evaluation strategy.
...
4. **Methodology**: 
   ...
   - The VietOCR architecture (VGG19 Encoder + Transformer Decoder) and domain-adaptation fine-tuning.
